    ...
    if data:
        ...
        for item in data:
            ...
            combined_text = (
                ...
                f"الرابط الرسمي (Official URL): {item.get('official_url', 'N/A')}"
            )
...
5. Follow-up Questions (الأسئلة التفاعلية في النهاية): 
   ...
   - الأول: اسأل عما إذا كان يريد تفاصيل إضافية عن الموضوع الحالي.
   - الثاني: اسأل عما إذا كان يود استكشاف أقسام أخرى.
6. Conditional Source Links (الروابط الشرطية):
   - لا تقم أبداً بإدراج الروابط الرسمية (Official URLs) أو مصادر الويب في إجابتك إلا إذا طلب المستخدم ذلك صراحة (مثلاً إذا قال: "ما هو رابط المشروع؟" أو "أريد المصدر الرسمي"). إذا لم يطلب الرابط، اكتفِ بعرض التفاصيل والحالة فقط دون ذكر الروابط.
